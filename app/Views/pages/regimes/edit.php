...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h2>Modifier le régime: <?= htmlspecialchars($regime['name']); ?></h2>
            <hr/>
            ...
            <form method="post" action="/regimes/<?= $regime['id']; ?>/update">
                <?= csrf_field(); ?>

                <div class="mb-3">
                    <label for="name" class="form-label">Nom du régime *</label>
                    <input type="text" class="form-control" id="name" name="name" required 
                           value="<?= htmlspecialchars($regime['name']); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="calories_per_day" name="calories_per_day" 
                           min="500" max="5000" required value="<?= $regime['calories_per_day']; ?>">
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label">Description</label>
                    <textarea class="form-control" id="description" name="description" rows="3"><?= htmlspecialchars($regime['description']); ?></textarea>
                </div>
