...
class UserGoalsPlanModel extends Model
{
    ...
    {
        return $this->select('user_goals_plan.*, regimes.name as regime_name, regimes.calories_per_day, regimes.description as regime_description, activities.name as activity_name, activities.calories_burn_per_hour')
